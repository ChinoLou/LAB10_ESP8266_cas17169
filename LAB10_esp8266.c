 ...
 *  LABORATORIO 10: Módulo Wi-fi ESP8266
 *  Fecha: 18/05/2020
 *  Sección: 12
 *
 */
...
int main(void){
    ...
    sendWord("CLARO1_DC7384");               //Nombre[SSID] Red Wi-fi
    UARTCharPut(UART1_BASE,'"');
    UARTCharPut(UART1_BASE,',');
    UARTCharPut(UART1_BASE,'"');
    sendWord("8831vCtQpS");                  //pasword: Wi-fi
    UARTCharPut(UART1_BASE,'"');
    sendWord("\r\n");
    SysCtlDelay(30000000);
    ...
    while(1){
        ...
        case 0:
            ...
            datos = "POST /index.php HTTP/1.0\r\nHost:  192.168.1.23\r\nAccept: */*\r\nContent-Length: 37\r\nContent-Type: application/x-www-form-urlencoded\r\n\r\ncarnet=17169&id_color=0&color=Negro   ";
            break;
        case 1:
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3, 0x00);
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_2, GPIO_PIN_2);
            datos = "POST /index.php HTTP/1.0\r\nHost:  192.168.1.23\r\nAccept: */*\r\nContent-Length: 37\r\nContent-Type: application/x-www-form-urlencoded\r\n\r\ncarnet=17169&id_color=1&color=Azul    ";
            break;
        case 2:
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3, 0x00);
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_3, GPIO_PIN_3);
            datos = "POST /index.php HTTP/1.0\r\nHost:  192.168.1.23\r\nAccept: */*\r\nContent-Length: 37\r\nContent-Type: application/x-www-form-urlencoded\r\n\r\ncarnet=17169&id_color=2&color=Verde   ";
            break;
        case 3:
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3, 0x00);
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_3, GPIO_PIN_3);
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_2, GPIO_PIN_2);
            datos = "POST /index.php HTTP/1.0\r\nHost:  192.168.1.23\r\nAccept: */*\r\nContent-Length: 37\r\nContent-Type: application/x-www-form-urlencoded\r\n\r\ncarnet=17169&id_color=3&color=Turquesa";
            break;
        case 4:
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3, 0x00);
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1, GPIO_PIN_1);
            datos = "POST /index.php HTTP/1.0\r\nHost:  192.168.1.23\r\nAccept: */*\r\nContent-Length: 37\r\nContent-Type: application/x-www-form-urlencoded\r\n\r\ncarnet=17169&id_color=4&color=Rojo    ";
            break;
        case 5:
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3, 0x00);
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1, GPIO_PIN_1);
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_2, GPIO_PIN_2);
            datos = "POST /index.php HTTP/1.0\r\nHost:  192.168.1.23\r\nAccept: */*\r\nContent-Length: 37\r\nContent-Type: application/x-www-form-urlencoded\r\n\r\ncarnet=17169&id_color=5&color=Violeta ";
            break;
        case 6:
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3, 0x00);
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1, GPIO_PIN_1);
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_3, GPIO_PIN_3);
            datos = "POST /index.php HTTP/1.0\r\nHost:  192.168.1.23\r\nAccept: */*\r\nContent-Length: 37\r\nContent-Type: application/x-www-form-urlencoded\r\n\r\ncarnet=17169&id_color=6&color=Amarillo";
            break;
        case 7:
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3, 0x00);
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1, GPIO_PIN_1);
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_2, GPIO_PIN_2);
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_3, GPIO_PIN_3);
            datos = "POST /index.php HTTP/1.0\r\nHost:  192.168.1.23\r\nAccept: */*\r\nContent-Length: 37\r\nContent-Type: application/x-www-form-urlencoded\r\n\r\ncarnet=17169&id_color=7&color=Blanco  ";
            break;
        default :
            GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3, 0x00);
            break;
